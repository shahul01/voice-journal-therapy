...
CREATE INDEX idx_goal_check_ins_created_at ON public.goal_check_ins(created_at DESC);

-- Assessment indexes
CREATE INDEX idx_assessment_results_user_id ON public.assessment_results(user_id);
CREATE INDEX idx_assessment_results_template_id ON public.assessment_results(assessment_template_id);
...
CREATE INDEX idx_user_summaries_period_type ON public.user_summaries(period_type);
CREATE INDEX idx_user_summaries_period_start ON public.user_summaries(period_start DESC);
...
CREATE INDEX idx_crisis_alerts_crisis_event_id ON public.crisis_alerts(crisis_event_id);
